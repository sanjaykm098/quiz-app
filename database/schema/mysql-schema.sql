...
CREATE TABLE `questions` (
  ...
  KEY `questions_uuid_index` (`uuid`),
  KEY `questions_type_index` (`type`),
  KEY `questions_difficulty_index` (`difficulty`),
  KEY `questions_question_index` (`question`),
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `email_verification_token` varchar(6) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_01_01_130530_add_col_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_01_16_155513_create_user_details_table',1);
